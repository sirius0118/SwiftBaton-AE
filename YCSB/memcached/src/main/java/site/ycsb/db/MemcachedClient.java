...
public class MemcachedClient extends DB {
  ...
  public static final String DEFAULT_SHUTDOWN_TIMEOUT_MILLIS = "100";
  ...
  public static final String DEFAULT_OP_TIMEOUT = "100";
  ...
  protected net.spy.memcached.MemcachedClient createMemcachedClient()
    ...
    connectionFactoryBuilder.setFailureMode(FAILURE_MODE_PROPERTY_DEFAULT);
  ...
  public Status update(
    ...
    //     Status status = getReturnCode(future);
        
    //     // if(status.getName().equals("OK")){
