...
public class CoreWorkload extends Workload {
  ...
  public static final String REQUEST_ZIPF_ZETA = "zipfzeta";
  public static final String REQUEST_ZIPF_ZETA_DEFAULT = "0.99";
  /**
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    double zipfzeta = Double.parseDouble(
        p.getProperty(REQUEST_ZIPF_ZETA, REQUEST_ZIPF_ZETA_DEFAULT));
    int minscanlength =
    ...
    if (requestdistrib.compareTo("uniform") == 0) {
      ...
      keychooser = new ScrambledZipfianGenerator(insertstart, insertstart + insertcount + expectednewkeys, zipfzeta);
